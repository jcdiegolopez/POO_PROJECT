...
public class Sistema {
    ...
    public static void main(String[] args) {
        ...
        Proyecto nuevoProyecto = new Proyecto(titulo, descripcion, fechaVencimiento);
...
public class Pruebas {
    ...
    public static void main(String[] args) {
        ...
        String descripcion = scanner.nextLine();
        System.out.print("Fecha de vencimiento (dd/mm/yyyy): ");
        String fechaVencimiento = scanner.nextLine();Proyecto nuevoProyecto = new Proyecto(titulo, descripcion, fechaVencimiento);
        System.out.println("Proyecto creado exitosamente!\n");
